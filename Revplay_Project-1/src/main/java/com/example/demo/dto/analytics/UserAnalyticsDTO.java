...
public class UserAnalyticsDTO {
    ...
    private List<Map<String, Object>> topSongs;   // [{title: "...", count: 5}, ...]
    private List<Map<String, Object>> topArtists; // [{name: "...", count: 10}, ...]
    private List<Map<String, Object>> topGenres;  // [{genre: "...", count: 3}, ...]
